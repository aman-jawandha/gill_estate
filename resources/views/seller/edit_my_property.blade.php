    ...
    <section class="south-contact-area section-padding-25">
        <div class="container p-4 p-md-5">
                ...
                <div class="col-12">
                    <div class="contact-heading" style="margin-bottom: 20px">
                        <h6><a href="{{ route('dashboard') }}"><i class="fa fa-home"></i></a> / <a
                                href="{{ route('my-properties') }}">My Properties</a> / <a>Edit Property</a></h6>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card p-4">
                        <form method="POST" action="{{ route('update-my-property') }}" id="property_form"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="title" id="title"
                                        value="{{ $property->title }}" maxlength="250" required placeholder="Enter Title">
                                </div>
                                <div class="col-md-12">
                                    <label class="form-label">Features</label>
                                    <textarea class="form-control" style="min-height:150px" rows="7" name="features" id="summernote" required
                                        maxlength="5000" placeholder="Write About Proerty">{{ $property->features }}</textarea>
                                </div>
                                <div class="col-md-12">
                                    <label class="form-label">Street</label>
                                    <input type="text" class="form-control" name="street" id="street"
                                        value="{{ $property->street }}" required maxlength="250" placeholder="Enter Street">
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select id="state" name="state" class="form-control" required>
                                        @if ($property->state)
                                            ...
                                            <option value="{{ $property->state }}" selected>{{ $property->state }}
                                            </option>
                                        @else
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" value="{{ $property->zip_code }}"
                                        name="zip_code" id="zip_code" required maxlength="6">
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <select class="form-control" name="type" id="type" required>
                                        ...
                                        @foreach ($types as $type)
                                            <option value="{{ $type->type }}"
                                                {{ $property->type == $type->type ? 'selected' : '' }}>
                                                {{ $type->type }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select id="furnishing" name="furnishing" required class="form-control">
                                        ...
                                        <option value="Fully Furnished"
                                            {{ $property->furnishing == 'Fully Furnished' ? 'selected' : '' }}>Fully
                                            Furnished</option>
                                        <option value="Semi Furnished"
                                            {{ $property->furnishing == 'Semi Furnished' ? 'selected' : '' }}>Semi
                                            Furnished</option>
                                        <option value="Non Furnished"
                                            {{ $property->furnishing == 'Non Furnished' ? 'selected' : '' }}>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select id="urgent_sell" name="urgent_sell" required class="form-control">
                                        <option value="" selected disabled>Select An Option</option>
                                        <option value="Yes" {{ $property->urgent_sell == 'Yes' ? 'selected' : '' }}>Yes
                                        </option>
                                        <option value="No" {{ $property->urgent_sell == 'No' ? 'selected' : '' }}>No
                                        </option>
                                    </select>
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <select id="bed_rooms" name="bed_rooms" required class="form-control">
                                        ...
                                        <option value="0" {{ $property->bed_rooms == '0' ? 'selected' : '' }}>0
                                        </option>
                                        <option value="1" {{ $property->bed_rooms == '1' ? 'selected' : '' }}>1
                                        </option>
                                        <option value="2" {{ $property->bed_rooms == '2' ? 'selected' : '' }}>2
                                        </option>
                                        <option value="3" {{ $property->bed_rooms == '3' ? 'selected' : '' }}>3
                                        </option>
                                        <option value="4" {{ $property->bed_rooms == '4' ? 'selected' : '' }}>4
                                        </option>
                                        <option value="5+" {{ $property->bed_rooms == '5+' ? 'selected' : '' }}>5+
                                        </option>
                                    </select>
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <select id="bath_rooms" name="bath_rooms" required class="form-control">
                                        ...
                                        <option value="1" {{ $property->bath_rooms == '1' ? 'selected' : '' }}>1
                                        </option>
                                        <option value="2" {{ $property->bath_rooms == '2' ? 'selected' : '' }}>2
                                        </option>
                                        <option value="3" {{ $property->bath_rooms == '3' ? 'selected' : '' }}>3
                                        </option>
                                        <option value="4" {{ $property->bath_rooms == '4' ? 'selected' : '' }}>4
                                        </option>
                                        <option value="5+" {{ $property->bath_rooms == '5+' ? 'selected' : '' }}>5+
                                        </option>
                                    </select>
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <input type="number" class="form-control" step="0.01"
                                        value="{{ $property->price }}" name="price" id="price" required
                                        min="1" max="10000000">
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <select name="built_year" class="form-control" id="built_year" required>
                                        ...
                                        @for ($i = date('Y'); $i >= 1800; $i--)
                                            <option value="{{ $i }}"
                                                {{ $property->built_year == $i ? 'selected' : '' }}>
                                                {{ $i }}</option>
                                        @endfor
                                    </select>
                                </div>
