                ...
                <div class="col-12">
                    <div class="contact-heading" style="margin-bottom: 20px">
                        <h6><a href="{{ route('dashboard') }}"><i class="fa fa-home"></i></a> / <a
                                href="{{ route('my-properties') }}">My Properties</a> / <a>Sell A Property</a></h6>
                    </div>
                </div>
            </div>
            @include('website_layout.common')
            <p>1. Your property will appear in the listings after admin approval.<br>
                2. The status will update automatically based on the decision.<br>
                3. If your property is rejected, you can view the reason in the <b>My Properties</b> page.
            </p>
            <div class="row">
                <div class="col-md-12">
                    <div class="card p-4">
                        <form method="POST" action="{{ route('store-my-property') }}" id="property_form"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" rows="7" style="min-height:150px" name="features" id="summernote" required
                                        maxlength="5000" placeholder="Write About Proerty"></textarea>
                                </div>
                                <div class="col-md-12">
                                    <label class="form-label">Street</label>
                                    <input type="text" class="form-control" name="street" id="street" required
                                        maxlength="250" placeholder="Enter Street">
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="number" class="form-control" step="0.01" name="price"
                                        id="price" required min="1" max="10000000">
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control" step="0.01" name="area"
                                        id="area" required min="1" max="20000">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label">Floor No.</label>
                                    <input type="number" class="form-control" name="floor_number" id="floor_number"
                                        required min="0" max="200">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label">Total Floors</label>
                                    <input type="number" class="form-control" name="total_floors" id="total_floors"
                                        required min="0" max="200">
                                </div>
                                <div class="col-md-6">
