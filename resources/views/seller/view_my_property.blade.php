        ...
        <div class="container-fluid p-4 p-md-5">
                ...
                <div class="col-md-6">
                    <div class="contact-heading" style="margin-bottom: 20px">
                        <h6><a href="{{ route('dashboard') }}"><i class="fa fa-home"></i></a> / <a
                                href="{{ route('my-properties') }}">My Properties</a> / <a>View Property</a></h6>
                    </div>
                </div>
                <div class="col-md-6 text-right">
                    @if($property->status == 'Pending' || $property->status == 'Rejected') 
                    <a href="{{ route('edit-my-property', $property->id) }}" class="btn btn-success"><i
                            class="fa fa-edit"></i></a>
                            @endif
                    <button class="btn btn-danger"
                        onclick="confirmDelete('{{ route('delete-my-property', $property->id) }}', 'Property')"><i
            ...
            <div class="card p-4">
                ...
                <div class="text-right">
                    <button type="button" onclick="store_images()" class="btn btn-primary">Add
                        Images</button>
                                ...
                                <div class="position-relative mt-2 mb-2">
                                    <div class="position-absolute top-0 end-0" style="z-index: 10;">
                                        ...
                                        <button type="button" onclick="update_image('{{ $image->id }}')"
                                            ...
                                            @endif
                                        <button class="btn btn-danger"
                                            onclick="confirmDelete('{{ route('delete-my-property-media', $image->id) }}', 'Image')"><i
                                                class="fa fa-trash"></i></button>
                                    </div>
                                ...
                                <div class="border p-2">
                                    <div class="text-right mb-4">
                                        ...
                                        <button type="button"
                                            ...
                                            @endif
                                        <button class="btn btn-danger"
                                            onclick="confirmDelete('{{ route('delete-my-property-media', $video->id) }}', 'Video')"><i
                                                class="fa fa-trash"></i></button>
                                    </div>
                                    <a href="{{ asset('uploads/properties/videos/' . $video->file) }}" target="_blank"><img
                                            width="100px" src="{{ asset('assets/img/video_img.png') }}"
                                            alt="Video"></a>
                                    <br>
            ...
            <div class="modal fade" id="add_images_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('store-my-property-images') }}" id="property_images_form" method="post"
            ...
            <div class="modal fade" id="add_video_modal" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('store-my-property-video') }}" id="property_video_form" method="post"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="modal-body">
                                <input type="hidden" name="property_id" value="{{ $property->id }}">
